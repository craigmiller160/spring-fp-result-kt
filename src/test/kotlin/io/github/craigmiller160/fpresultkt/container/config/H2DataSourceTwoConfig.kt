...
@EnableJpaRepositories(
    basePackages = ["io.github.craigmiller160.fpresultkt.container.domain.ds2.repositories"],
...
class H2DataSourceTwoConfig {
  ...
  fun dataSourceTwoEntityManagerFactoryBean(
      ...
      LocalContainerEntityManagerFactoryBean().apply {
        ...
        setPackagesToScan("io.github.craigmiller160.fpresultkt.container.domain.ds2.entities")

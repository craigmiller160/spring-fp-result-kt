...
import io.craigmiller160.springarrowkt.container.config.PostgresDataSourceOneConfig
...
class SpringNestedTransactionPersonService(private val personRepository: PersonRepository) {
  ...
  @Transactional(transactionManager = PostgresDataSourceOneConfig.TXN_MANAGER)
  ...
  @Transactional(
      ...
      transactionManager = PostgresDataSourceOneConfig.TXN_MANAGER)
